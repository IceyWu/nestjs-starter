import { randomAvatar, randomName } from '@/helper'
...
export class AuthService {
  ...
  async resetPasswordByUser(data: any, user: User) {
  ...
  async updateUserInfoByUser(data: User, user: User) {
    const { userId, ...dataT } = data
    return this.prisma.user.update({
      where: { id: +userId },
      data: {
        ...dataT,
